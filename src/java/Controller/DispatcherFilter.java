...
public class DispatcherFilter implements Filter
{
            ...
            throws IOException, ServletException
    {
        ...
        //first process request servlet (or filter) instead doing like this.
        String url = "welcum.jsp";
        
        //doBeforeProcessing(request, response);
        //preventing people back tracking
        ...
        try
        {
            ...
            //ReadRoadMap rm = (ReadRoadMap)context.getAttribute("ROAD_MAP");
            //int test = rm.volume();
            //url = rm.getResource(resource);
        ...
        {
            log("FilterDispatcher gone wrong _ " + t.getMessage());
        }
